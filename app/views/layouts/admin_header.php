        ...
        <div class ="admin-header-row col-xl-4 col-lg-5 col-md-6 col-sm-6 col-8  d-flex flex-column">
            <div class="icons d-flex align-items-center justify-content-between">
                 <div class="icons__item icons__item_padding d-flex  align-items-center">
                    <img src="/template/images/icons/forSite.png" alt="">
                     <div class="content-form__data text__item"><a href="/admin" class="brownDark fontSans size29px">АдминПанель</a></div>
                </div>
                 <div class="icons__item icons__item_padding d-flex  align-items-center">
                    <img src="/template/images/icons/adminAccount.png" alt="">
                     <div class="content-form__data text__item"><a href="" class="brownDark fontSans size29px"><?php echo $user['name'];?></a></div>
                </div>
            </div>
        </div>
         <div class="icons__item icons__item_padding d-flex  align-items-center ">
                    <img src="/template/images/icons/admin.png" alt="">
