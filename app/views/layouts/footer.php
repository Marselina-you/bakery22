   <div class ="header-up-footer col-xl-6 offset-xl-6 col-lg-6 offset-lg-6 col-md-6 offset-md-6 col-sm-10 offset-sm-0 col-10 offset-0 py-3">
        <div class="pt-2 header d-flex justify-content-xl-end justify-content-lg-end justify-content-md-end justify-content-sm-center justify-content-between">
            <div class="icons col-xl-8 col-lg-10 col-md-11 col-sm-8 col-12 d-flex align-items-center justify-content-between"><div class="p-2 d-flex  flex-column align-items-center">
                ...
                <div class="p-2 d-flex flex-column align-items-center"><a href="/catalog">
                 ...
                 <div class="p-2 d-flex  flex-column align-items-center">
                    <a href="/cart"><img src="/template/images/icons/basket.png" alt=""></a>
                     <div class="main-start-name__item2 lh-base brownDark fontSans fs-6"><a href="/cart/"></a><span id="cart-count"><?php if(Cart::countItems() > 0): echo'('; echo Cart::countItems();  echo ')';?><?php endif; ?></span></div>
                </div>
               <div class="p-2 d-flex  flex-column align-items-center">
    ...
    <div class="wrap-footer-block col-lg-12">
        ...
        <div class="wrap-menu d-flex flex-column menu">
            ...
            <ul class="submenu">
              ...
              <?php if (User::isGuest()): ?>
                <li class="fs-2 text-light fontSans text-center"><a href="/user/login/"
                    class="baton">
               вход</a></li>
                <?php else: ?>
