                        ...
                        <div class="container-fluid">
                                ...
                                <form action="#" method="post" enctype="multipart/form-data" class="admin-product-form">
                                        <label class="admin-product-form__label">
                                                ...
                                                <input type="text" name="name" placeholder="" value="<?php echo $category['name_category']; ?>" class="admin-product-form__input">
                                        </label>
                                        <label class="admin-product-form__label">
                                                <span class="admin-product-form__caption">Sort_order</span>
                                                <input type="text" name="sort_order" placeholder="" value="<?php echo $category['sort_order']; ?>" class="admin-product-form__input">
                                        </label>
<label class="admin-product-form__label">
                                        ...
                                        <label class="admin-product-form__label">
                                                ...
                                                <input type="text" name="style" value="<?php echo $category['style']; ?>" class="admin-product-form__input">
                                        </label>
                                        <label class="admin-product-form__label">
                                                <span class="admin-product-form__caption">Style2</span>
                                                <input type="text" name="style2" value="<?php echo $category['style2']; ?>" class="admin-product-form__input">
                                        </label>
                                        <div class="">
