...
<div class="site-container">
        ...
        <main class="main-admin">
                ...
                <section class="admin-product admin-category">
                        <div class="container-fluid">
                                <h2 class="admin__title admin__title--active subtitle">Добавление новой категории</h2>
                                        ...
                                        <form action="#" method="post" enctype="multipart/form-data"
                                                ...
                                                <label class="admin-product-form__label">
                                                        ...
                                                        <input type="text" name="style2"
                                                                class="admin-product-form__input"></label>
                                                <div class="">
