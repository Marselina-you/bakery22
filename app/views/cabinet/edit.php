      ...
      <div class="container">
        ...
        <div class="suggestion result__suggestion">
          <a href="/cabinet">
            ...
            <svg viewBox="0 0 214.89859 281.45682" xmlns:svg="http://www.w3.org/2000/svg">
              <g data-name="1" transform="matrix(1,0,0,0.7043276,-187.1032,-35.490591)">
                <path
        ...
        <div class="signup-form">
          ...
          <form action="#" method="post" class="registration__form">
            ...
            <label class="main-form__label main-form__label--title">
              ...
              <input class="main-form__input" type="password" name="password" placeholder="Пароль"
