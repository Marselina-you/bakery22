...
<div class="d-flex col-xl-12">
                ...
                <div class="edit__title title_padding darkBlue fontSans size29px"><a href="/admin/product/categorya/<?php echo $categoryItem['id'];?>" class=""><?php echo $categoryItem['name_category'];?></a>
        </div>
