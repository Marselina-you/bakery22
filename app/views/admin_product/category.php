        ...
        <ul class="admin-products__list list-reset grid">
          ...
          <li class="admin-products__item">
            <div class="admin-products__left">
              ...
              <div class="admin-products__available">
                <?php if ($product['nal'] == 1) echo 'в наличии'; else echo 'нет в наличии';?></div>
              <div class="admin-products__status <?php echo $product['style']; ?>"><?php echo $product['value']; ?>
              </div>
            </div>
            <div class="admin-products__right">
              <h3 class="admin-products__title"><?php echo $product['name']; ?> <span>id
                  <?php echo $product['id']; ?></span> </h3>
              <div class="admin-products__subtitle">Описание
                ...
                <ul class="admin-products__components">
                  ...
                  <li class="admin-products__item admin-products__text">
                    <?php echo $product['ing2']; ?><?php echo $product['ing1']; ?></li>
                ...
                <div class="admin-products__subtitle">Слайдер
                  <span
                    class="admin-products__text"><?php if ($product['recommendation'] == 1) echo 'да'; else echo 'нет';?></span>
                </div>
                <ul class="admin-products__power list-reset">
                  <li class="admin-products__item"><a href=""
                      class="admin-products__link admin-products__link--unactive">Скрыть</a></li>
                  <li class="admin-products__item"><a href="/admin/product/update/<?php echo $product['id']; ?>"
                      class="admin-products__link admin-products__link--active">Редактировать</a></li>
                  <li class="admin-products__item"><a href="/admin/product/delete/<?php echo $product['id']; ?>"
                      class="admin-products__link admin-products__link--danger">Удалить</a></li>
                </ul>
              </div>
            </div>
          </li>
