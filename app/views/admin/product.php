...
<div class="d-flex col-xl-12">
                ...
                <div class="edit__title title_padding darkBlue fontSans size29px"><a href="category/<?php echo $categoryItem['id'];?>" class="col-xl-6 <?php if ($categoryId == $categoryItem['id']) echo 'active'; else echo'brownLight'; ?>"><?php echo $categoryItem['name'];?></a>
        </div>
