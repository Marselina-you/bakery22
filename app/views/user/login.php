...
<input type="email" name="email" placeholder="E-mail" class="main-form__input" value="<?php echo $email; ?>" />
</label>
<label for="parol" class="main-form__label main-form__label--title">
    <span class="main-form__caption">Пароль:</span>
<input type="password" name="password" placeholder="Пароль" class="main-form__input" value="<?php echo $password; ?>" />
</label>                       
