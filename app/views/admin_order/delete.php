  ...
  <main class="main-admin">
    ...
    <section class="admin-delete admin-category">
      <div class="container-fluid">
        <h2 class="admin__title admin__title--active subtitle">Удаление заказа #<?php echo $id; ?></h2>
        ...
        <div class="admin-delete__block">
          ...
          <div class="admin-delete__item">
            <a href="/admin/order" class="btn admin-delete__btn btn-reset btn--success">нет</a></div>
        </div>
      </div>
</div>
</div>
