        ...
        <div class="admin-order__block grid">
          ...
          <article class="admin-order__article">
            <ul class="admin-order__list list-reset">
              ...
              <li class="admin-order__item">
                <a href="/admin/order/delete/"
                  class="admin-order__btn admin-order__btn btn--success btn btn-reset">выполнить</a>
                <a href="/admin/order/update/<?php echo $order['id']; ?>"
                  class="admin-order__btn admin-order__btn btn btn-reset btn--primary">изменить</a>
                <a href="/admin/order/delete/<?php echo $order['id']; ?>"
                  class="admin-order__btn admin-order__btn btn btn-reset btn--danger">отменить</a>
              </li>
            </ul>
          </article>
          <?php endforeach; ?>
